...
class AccessController extends Controller
{
    ...
    public function uPLogin(Request $request)
    {
        ...
        if (empty($loginout) && Auth::attempt($credentials)) {
        ...
        if (!empty($useru)) {
            ...
            if (!empty($terminal)) {
				...
				*/
                ...
                /* Squidster: WARNING!
				   Here we check if system doesn't have the correct MAC
				   address in the DB, we don't allow access and immediately
				   log the user out. However Windows user will be affected.
