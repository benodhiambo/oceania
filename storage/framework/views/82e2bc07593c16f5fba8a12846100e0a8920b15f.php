	...
	<div class="container-fluid">
		...
		<div class="row  align-items-center"
			...
			<div class="col-md-3 d-flex justify-content-end">
				...
				<form action="<?php echo e(route('export_cstore_excel')); ?>"
...
function showPSSReceipt(date) {
	...
	$.ajax({
		url: "<?php echo e(route('pshift.list',[$date])); ?>",
		headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
		type: 'post',
		data: {date},
...
function onConfirmReceiptVoid() {
	...
	$.ajax({
		url: "<?php echo e(route('local_cabinet.cstore.voidReceipt')); ?>",
		type: 'post',
		headers: {
...
function onConfirmReceiptRefund() {
	...
	$.ajax({
		url: "<?php echo e(route('local_cabinet.cstore.refund')); ?>",
		type: 'post',
		headers: {
			'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
		},
...
function ptype_search(search) {
	if (search.length > 0) {
		...
		cstore_tbl_url = "<?php echo e(route('cstore.search.ptype',[$date])); ?>";
		cstore_tbl_data = {
		...
		cstore_tbl_url = "<?php echo e(route('local_cabinet.cstore-list-table',[$date])); ?>";
		cstore_tbl_data = {'date': '<?php echo e($date); ?>'}
		table.ajax.url( cstore_tbl_url ).load();
	}
}


var cstore_tbl_url = "<?php echo e(route('local_cabinet.cstore-list-table',[$date])); ?>";
var cstore_tbl_data = {'date': '<?php echo e($date); ?>'}
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev/oceania/trunk/oceania/resources/views/cstore/cstore_receiptlist.blade.php ENDPATH**/ ?>