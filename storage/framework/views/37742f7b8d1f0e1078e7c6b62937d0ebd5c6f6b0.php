            ...
            <div class="col-3 mb-5">
                ...
                <form class="">
                     ...
                     <div class="form-group" style="">
                        <label class="control-label">Nozzle <?php echo e($i); ?> </label>
                        <div class="">
                            <select class="form-control" autocomplete="off"  id="select_pmp_<?php echo e($k); ?>_n_<?php echo e($i); ?>">
                                <option value="<?php echo e($k); ?>_<?php echo e($i); ?>_0"></option>
                               ...
                               <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                               		<?php if($prd->og_fuel_id == $ogfuelid): ?>
                               		<option  selected="selected"
                                   		value="<?php echo e($k); ?>_<?php echo e($i); ?>_<?php echo e($prd->og_fuel_id); ?>">
                                       <?php echo e($prd->name); ?>&nbsp;<?php echo e(number_format(($prd->price/100),2)); ?>
...
function update_mapping() {
    ...
    if (update_array != undefined &&
        ...
        update_array.forEach(element => {
            ...
            $.ajax({
                    method: "post",
                    url: "<?php echo e(route('product_mapping.save_mapping')); ?>",
                    data: element,
                }).done((data) => {
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev/oceania/trunk/oceania/resources/views/product_mapping/product_mapping.blade.php ENDPATH**/ ?>