...
function updatePumpStatus(packet, my_pump) {
	...
	if (type === 'PumpFillingStatus') {
        ...
        if(pumpData['pump'+my_pump].status == 'Delivering') {
			...
			//nozzle down
			//enable_payment_btns();
			var type = getPumpStatus(my_pump);
			log2laravel('info', 'updatePumpStatus: type =' + type);

			if (type == 'PumpTotals') getPumpStatus(my_pump);
...
<!-- PUMPING LOOP END -->
<?php /**PATH /home/user/oceania/trunk/oceania/resources/views/landing/opos_pumpingloop.blade.php ENDPATH**/ ?>