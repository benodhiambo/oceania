		...
		<div class="row align-items-center"
			...
			<div class="row col-md-8 text-left m-0"
				style="justify-content:flex-end">
                 ...
                 <form action="<?php echo e(route('export_excel_fuel_receipt')); ?>"
				 	method="POST" style="margin-right: 0.5%;margin-bottom:0">
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev/oceania/trunk/oceania/resources/views/fuel_receipt/fuel_receiptlist.blade.php ENDPATH**/ ?>