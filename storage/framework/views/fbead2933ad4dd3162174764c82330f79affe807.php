...
window.onload = function() {
    $('#auditedReportList').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(route('cstore.listPrdAuditedRpt')); ?>",
        columns: [{
				"data": 'DT_RowIndex',
				orderable: false,
				searchable: false
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev/oceania/trunk/oceania/resources/views/cstore_audited_rpt/cstore_audited_report_list.blade.php ENDPATH**/ ?>