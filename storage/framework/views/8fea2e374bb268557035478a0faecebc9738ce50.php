...
<div class="container-fluid">
	...
	<div class="row py-2"
		...
		<div class="col align-self-center" style="width:80%">
			<h2 style="margin-bottom:0">Location Product: Stock In</h2>
		</div>
...
var tablestockin = $('#fuelMgt').DataTable({
	...
	"ajax": {
		...
		"type": "GET",
		"data": {"location_id": "<?php echo e($location->id); ?>", "db":"inventory"},
		'headers': {
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/oceania/trunk/oceania/resources/views/inv_stockmgmt/stockin.blade.php ENDPATH**/ ?>