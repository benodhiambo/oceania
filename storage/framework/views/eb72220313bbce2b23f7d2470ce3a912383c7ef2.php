...
//	'123456789012345678901234567890123456789012345'
	...
	<?php $__currentLoopData = $receiptproduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		...
		'<?php echo e(str_pad($i->discount_pct."%", 4, " ", STR_PAD_LEFT)); ?>' + '\x09' +
		'<?php echo e(str_pad(number_format(($i->quantity*($i->price/100)) - ($i->discount / 100),2), 7, " ", STR_PAD_LEFT)); ?>' + '\x0A',
...
//	'123456789012345678901234567890123456789012345'
	'Credit Account           ' + '<?php echo e(str_pad("0.00", 20, " ", STR_PAD_LEFT)); ?>' + '\x0A',
...
<?php /**PATH /home/user/oceania/trunk/oceania/resources/views/printing/cstore_receipt_template_escpos.blade.php ENDPATH**/ ?>