...
<div class="modal-body" style="font-size: 14px; font-weight: bold;">
    ...
    <div class="row">
        ...
        <div class="col-md-6" style="text-align: right;">
            <strong style="font-weight:normal" id="item_amount">
                <?php echo e(number_format(((($eodSales)??"0.00")/100),2)); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-6" style="text-align: right;">
            <strong id="item_amount" style="font-weight: normal;">
                <?php echo e(number_format((((($eodTax ?? 0 )- $reverseTax)??"0.00")/100),2)); ?>
    ...
    <div class="row" style="font-weight: normal">
        ...
        <div class="col-md-6" style="text-align: right;">
            <strong id="item_amount" style="font-weight: normal">
				<?php echo e(number_format($eodRound/100,2)); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-6" style="text-align: right;">
            <strong id="item_amount" style="font-weight: normal;">
                <?php echo e(number_format(((($eodCash)??"0.00")/100),2)); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-6" style="text-align: right;">
            <strong id="item_amount" style="font-weight: normal;">
                <?php echo e(number_format(((($eodCreditCard)??"0.00")/100),2)); ?>
	...
	<div class="row">
        ...
        <div class="col-md-6" style="text-align: right;">
            <strong id="item_amount" style="font-weight: normal;">
                <?php echo e(number_format(((($eodWallet)??"0.00")/100),2)); ?>
	...
	<div class="row">
        ...
        <div class="col-md-6" style="text-align: right;">
            <strong id="credit_account" style="font-weight: normal;">
                <?php echo e(number_format(((($eodcreditAccount)??"0.00")/100),2)); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-4" style="text-align: right;">
            <strong id="item_amount"
				...
				<?php echo e(empty($opos_eoddetails->creditcard) ? '0.00' :
					number_format(($opos_eoddetails->creditcard/100),2)); ?>
    ...
    <div class="row">
        <div class="col-md-8" style="font-weight: normal;">
            Outdoor Electronic Wallet
        </div>
        <div class="col-md-4" style="text-align: right;">
            <strong id="item_amount"
				style="font-weight: normal;">
				<?php echo e(number_format(((($eodOew)??"0.00")/100),2)); ?>
    ...
    <!--section 3 ends-->
	   ...
	   <?php if($refund_data != 0): ?>
		...
		<div class="row">
			...
			<div class="col-md-6 text-right" style="font-weight: normal;color:orange">
				<?php echo e(number_format(( $refund_data ??"0.00")/100,2)); ?>
		...
		<div class="row">
			...
			<div class="col-md-6 text-right" style="font-weight: normal;color:orange">
				<?php echo e(number_format(( $refund_sst ??"0.00") / 100,2)); ?>
	 ...
	 <!--section 3 starts-->
		<div class="row">
			...
			<div class="col-md-6 text-right" style="font-weight: normal;color:orange">
				<?php echo e(number_format(( $refund_round ??"0.00") / 100,2)); ?>
...
<?php /**PATH /home/user/oceania/trunk/oceania/resources/views/local_cabinet/eod_summarylist.blade.php ENDPATH**/ ?>