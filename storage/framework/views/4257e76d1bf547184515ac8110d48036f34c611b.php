...
function cover_process_finish(pump_no) {
    ...
    $("#custom_litre_btn_" + pmpno).removeClass('custom-preset-disable');
...
function process_custom_amt(pmpno, prd_id) {
    ...
    pumpData['pump' + pmpno].dose = display_input_amt
...
<?php /**PATH /home/dev/oceania/trunk/oceania/resources/views/landing/opos2_fuelpage.blade.php ENDPATH**/ ?>