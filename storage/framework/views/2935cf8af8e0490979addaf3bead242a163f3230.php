...
.col-md-1.receipt-item-discount {
    padding-left: 10px;
}
.receipt-item-l {
	text-align:left;
...
.col-md-2.receipt-item-discount {
    padding-right: 23px;
}
.col-md-2.receipt-item-c.text-center.price_class {
    padding: 0;
    margin: 0;
    padding-right: 12px;
...
<div class="modal-body pb-0"
	...
	<div class="row align-items-center">
		...
		<div class="text-center col-md-1 pl-2 pr-0">
			<strong>Qty</strong>
		</div>
		<div class="text-center col-md-3 pl-3 pr-0" style="text-align: center">
			<strong class="global_currency">Price</strong>
		</div>
		<div class="text-center col-md-1 pr-0" style="padding-left: 3px !important;">
			<strong>Disc.</strong>
		</div>
	...
	<div class="row align-items-center" style="font-weight: normal">
		...
		<div class="pl-3 col-md-2 receipt-item-c ">
			<?php echo e(!empty($product->quantity)?number_format($product->quantity):"1"); ?>

		</div>
		<div class=" col-md-2 receipt-item-c text-center price_class">
	...
	<div class="row">
		...
		<div class="col-md-6" style="text-align: right;" >
			...
			<?php echo e(number_format($item_amount/ 100, 2)); ?>
	...
	<div class="row" style="text-align: center;margin: 10px auto;">
		<div class="col-md-12 d-flex"
			...
			-->
			<a target="_blank"
				href="<?php echo e(route('local_cabinet.loyaltyPoints',$receipt->id)); ?>">
        ...
        <?php if($refund || $receipt->status=='voided'): ?>
					disabled="disabled"
				<?php endif; ?>
     			<?php if(!$refund || $receipt->status !='refunded'): ?>
	...
	<!--- void by --->
	<div id="void-div<?php echo e($receipt->id??''); ?>"
		style="font-size:14px;font-weight:normal;display:
		<?php if($receipt->status=='voided'): ?>
			block
		<?php else: ?>
			none
		...
		<div class="row">
			<div class="col-md-6 text-left"  style="color:red;">
				<b>  <?php echo e($user->fullname??''); ?></b>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6 text-left"  style="color:red;">
				<b><?php echo e($user->systemid??''); ?></b>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6 text-left"  style="color:red;">
				<b id="void-time<?php echo e($receipt->id??''); ?>">
				<?php echo e(date('dMy', strtotime($receipt->voided_at))); ?>
		...
		<div class="row">
			<div class="col-md-6 text-left"  style="color:red;">
				<b id="void-reason<?php echo e($receipt->id??''); ?>">
				<?php echo e($receipt->void_reason??''); ?>
	...
	<?php if($refund): ?>
		<div class="text-left"
			style="margin-left:15px;font-size:14px;font-weight:normal;color:orange">
			Refunded By:
			<br>
...
<?php /**PATH /home/dev/oceania/trunk/oceania/resources/views/cstore/cstore_receipt.blade.php ENDPATH**/ ?>