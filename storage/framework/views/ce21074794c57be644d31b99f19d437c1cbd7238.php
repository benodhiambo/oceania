...
<div class="modal fade" id="eodSummaryListModal" tabindex="-1" role="dialog"
	...
	<div class="modal-dialog modal-dialog-centered mw-75"
		...
		<div id="eodSummaryListModal-table-div"
			...
			style="width:370px; border-radius:10px;">
		</div>
	</div>
</div>
...
<div class="modal fade bd-example-modal-lg" id="optlistModal"
	...
	<div class="modal-dialog modal-xl modal-dialog-centered">
		<div class="modal-content bg-purplelobster"
			 style="color:white !important; border-radius:10px;">
			<div class="modal-header">
...
<div class="modal fade bd-example-modal-lg" id="eodpssModal_1"
	tabindex="-1" role="dialog"
	aria-hidden="true" style="display:none">
	<div class="modal-dialog modal-dialog-centered modal-md"
		 role="document">
		<div class="modal-content bg-purplelobster" id=""
		...
		<div class="row align-items-center">
			...
			<div class="col-6">
				<input class="form-control text-right"
					...
					placeholder="0.00" onkeyup='enforceMinMax(this)' />
...
$(document).ready(function() {
	...
	var eodtable = $('#eodsummarylist').DataTable({
		...
		"serverSide": true,
		async: false,
		"ajax": "<?php echo e(route('local_cabinet_data_table')); ?>",
		columns: [
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev/oceania/trunk/oceania/resources/views/local_cabinet/local_cabinet.blade.php ENDPATH**/ ?>