    ...
    <div class="">
		...
		<div class="d-flex mt-0 p-0 row" style="width:100%;margin-top:5px !important;margin-bottom:5px !important" >
			<div class="col-md-5 align-self-center" style="">
				<h2 style="margin-bottom: 0;">Open Item: Cost</h2>
			</div>
            ...
            <div class="col-md-1 align-self-center">
				<img src="/images/product/<?php echo e($prd_info->systemid); ?>/thumb/<?php echo e($prd_info->thumbnail_1); ?>"
					...
					style="object-fit:contain;border-radius:10px;float:right;">
			</div>
        ...
        <div style="margin-top: 0;">
	        <table border="0" cellpadding="0" cellspacing="0" class="table" id="openitemCostTable" style="margin-top: 5px; width:100%">
            <thead class="thead-dark " style="">
            <tr id="table-th" style="border-style: none;">
                <th valign="middle" class="text-center" style="">No</th>
                <th valign="middle" class="" style="text-align:left!important">Date</th>

                <th valign="middle" class="text-center center-header" style="">Cost</th>
                <th valign="middle" class="text-center center-header" style="">Qty</th>
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/oceania/trunk/oceania/resources/views/openitem/openitem_cost.blade.php ENDPATH**/ ?>