...
function getH2ReceiptList(data) {
	...
	$.ajax({
		method: "post",
		url: "<?php echo e(route('h2.envReceipt')); ?>",
		data: {
			id: data
		}
	}).done((data) => {
...
function getH2PersonalShiftReceiptList(receipt_id,staff_user_id) {
	...
	$.ajax({
			method: "post",
			url: "<?php echo e(route('h2.envPersonalShiftReceipt')); ?>",
			data: {
				"id": receipt_id,
...
function refundMe(id, fuel, filled) {
	...
	$.ajax({
			method: "post",
			url: "<?php echo e(route('h2.refund')); ?>",
			data: {
				id: id,
				filled: filled,
				fuel: fuel
...
"autoWidth": false,
"ajax": {
	"url": "<?php echo e(route('h2-list-table')); ?>",
	"type": "POST",
	data: {
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/oceania/trunk/oceania/resources/views/h2_receipt/h2_receiptlist.blade.php ENDPATH**/ ?>