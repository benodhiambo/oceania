        ...
        <div class="col-md-4 hidden-md-down" style="">
			<div class="pl-3"
				...
				<span>Log In</span>
					...
					<?php echo e(date('dMy H:i:s', strtotime($user->last_login??''))); ?></span><br>
					<span>Merchant</span>
					...
					<span>Location</span>
						<span class="float-right"
						id="location_name"><?php echo e($location->name??''); ?></span><br>
					<span>Location ID</span>
						<span class="float-right" id="location_id">
                            <?php echo e($location->systemid??''); ?></span><br>
					<span>Segment</span>
...
<?php echo $__env->make('oceania_svr.common.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div id="thumbnail_1" class="thmb" style="">
					...
					<?php if(in_array(pathinfo($location->e_right_panel_image_file )['extension'], ['mp4', '3gp', 'avi', 'flv', 'mpeg'])): ?>
						...
						<video style="background-color:white;object-fit:contain"
							...
							<source src="/images/location/<?php echo e($location->id); ?>/<?php echo e($location->e_right_panel_image_file); ?>" type="video/mp4">
						</video>
					</a>
...
<?php echo $__env->make('oceania_svr.common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev/oceania/trunk/oceania/resources/views/oceania_svr/screen_d/screen_d.blade.php ENDPATH**/ ?>