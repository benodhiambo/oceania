		...
		<tr>
			...
			<td style="text-align: center;
				...
				<a href="#" style="text-decoration: none;"
					onclick="showReceipt(<?php echo e($row->show_receipt_id); ?>)"><?php echo e($row->systemid); ?>
			...
			<td style="text-align: center;" nowrap> 0.00  </td>
			<td style="text-align: center;">
				<?php if($row->status=='voided'): ?>
					0
				<?php else: ?>
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/oceania/trunk/oceania/resources/views/openitem/openitem_productledger.blade.php ENDPATH**/ ?>