	...
	<div class="row justify-content-center" style="height:94%">
		<div class="col-md-8 hidden-md-down"
			...
			<div>
				...
				<button class="btn btn-success btn-sq-lg
					screend-button-lg bg-screend-night-black"
					onclick="window.open('<?php echo e(route('local.hydrogenprice')); ?>','_blank')"
                ...
                <button class="btn btn-success btn-sq-lg
					bg-screend-night-black screend-button p-0"
					onclick="window.open('<?php echo e(route('manual_record_list')); ?>')"
			...
			<div>
				...
				<button class="btn btn-success btn-sq-lg screend-button
					...
					bg-screend-product"
					onclick="window.open('<?php echo e(route('report')); ?>','_blank')"
					style="font-size: 14px">
					<span style="">
						C-Store<br>Report
					</span>
				...
				<button class="btn btn-success btn-sq-lg
					screend-button-lg bg-screend-product"
					onclick="window.open('<?php echo e(route('cstore_receiving_notes_list')); ?>','_blank')"
					style="font-size: 14px">Receiving Note
				</button>

				<button class="btn btn-success btn-sq-lg screend-button
					bg-screend-product"
					onclick="window.open('<?php echo e(route('cstore_returning_list')); ?>','_blank')"
					style="font-size: 14px">Returning
				</button>

				<button class="btn btn-success btn-sq-lg
					screend-button-lg bg-screend-product"
					onclick="window.open('<?php echo e(route('cstore_audited_notes_list')); ?>','_blank')"
					style="font-size: 14px">Audited Report
				</button>

				<!--
				<button class="btn btn-success screend-button"
					onclick="window.open('<?php echo e(route('export_stock_ledger_excel')); ?>')"
			...
			<div>
				...
				<button class="btn btn-success btn-sq-lg
					screend-button-lg bg-screend-opt-mgmt"
					onclick="window.open('<?php echo e(route('outdoor.e.wallet.provider.information')); ?>','_blank')"
...
<div style="position: absolute; bottom: 30px; right:30px">
	...
	<img style="object-fit:contain;width:220px !important"
		 src="<?php echo e(asset('images/ocosystem_logo_slgwht-14.png')); ?>"/>
</div>
					...
					<div class="upload-area" id="uploadfile" style='border:
						...
						<?php if(!empty($location->e_right_panel_image_file)): ?>
							<div id="thumbnail_1" class="thmb" style="">
								...
								<?php if(in_array(pathinfo($location->e_right_panel_image_file )['extension'], ['mp4', '3gp', 'avi', 'flv', 'mpeg', 'webm', 'ogv'])): ?>
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev/oceania/trunk/oceania/resources/views/screen_d/screen_d.blade.php ENDPATH**/ ?>