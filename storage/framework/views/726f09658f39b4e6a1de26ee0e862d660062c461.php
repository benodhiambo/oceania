...
<body>
		...
		<tr>
			<td valign="bottom" colspan="5" align="right" >
				...
				<?php if(!empty($requestValue['start_date']) && !empty($requestValue['end_date'])): ?>
					<?php echo e(date('dMy',strtotime($requestValue['start_date']))); ?> - <?php echo e(date('dMy',strtotime($requestValue['end_date']))); ?>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="table" id="item" style="margin-top: 5px; width:100%">
        ...
        <?php $__currentLoopData = $product_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr class="table-td">
                ...
                <td style="text-align:center;border-style: none">
					...
					<?php else: ?>
						<?php echo e((int) $product->quantity); ?>

					<?php endif; ?>
                </td>
				<!--
				<td style="text-align:right;border-style: none">
					<?php echo e(number_format($product->rec_price/($product->tax+100),2)); ?>
        ...
        <tr>
            <td colspan="5" align="right" valign="middle">
                <p style="text-decoration-line: none;font-size: 15px;font-weight:700; padding: 0;margin: 0;margin-top: -7px">
	...
	<h2 style="margin-bottom:5px !important" class="">Receipt Refund
	<span style="font-size:18px;float:right;position:relative;top:8px;">C-Store</span>
	</h2>
    <table border="0" cellpadding="0" cellspacing="0" class="table"
        ...
        <tr id="table-th" style="border-style: none">
            ...
            <th valign="middle" class="text-left" style="width:75%;">Receipt ID</th>
        ...
        $grandTotal=0;
        ?>
        <?php $__currentLoopData = $receipt_refund; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $receipt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            $grandTotal+=$receipt->refund_amount;
            ?>
            <tr class="table-td">
                <td class="text-center" style="border-style: none">
					<?php echo e($key + 1); ?>
                ...
                <td class="text-left" style="border-style: none">
					<?php echo e($receipt->systemid); ?>

				</td>
                <td style="text-align:right;border-style: none">
                    <?php echo e(number_format($receipt->refund_amount,2)); ?>
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="table"
		id="item" style="margin-top: 5px; width:100%">
        <tr>
			<td>
...
<?php /**PATH /home/user/oceania/trunk/oceania/resources/views/sales_report/sales_report_pdf.blade.php ENDPATH**/ ?>