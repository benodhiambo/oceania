    ...
    <div class="container-fluid">
        ...
        <tbody>
           <?php $__currentLoopData = $receiving_note_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="table-td">
                <td class="text-center" style="border-style: none; width:30px;">
                    <?php echo e($key +1); ?>

				</td>
                <td  class="text-left" style="border-style: none">
                     <a href="<?php echo e(route('receiving_list_id',$list->recvnote_systemid)); ?>" style="text-decoration:none;" target="_blank"> <?php echo e($list->recvnote_systemid); ?></a>
                </td>
                <td class="text-center" style="border-style: none; width:150px;" >
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev/oceania/trunk/oceania/resources/views/receiving_note/cstore_receiving_note_list.blade.php ENDPATH**/ ?>