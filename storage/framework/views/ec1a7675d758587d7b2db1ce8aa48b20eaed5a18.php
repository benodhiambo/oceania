    ...
    <div class="container-fluid">
		...
		<div class="d-flex mt-0 p-0" style="width:100%;margin-top:5px !important;margin-bottom:5px !important" >
			...
			<div class="col-md-2 text-right pr-0 mb-0"
				...
				<i onclick="window.open('<?php echo e(route('audited_notes')); ?>','_blank')"
        ...
        <tbody>
           <?php $__currentLoopData = $audited_report; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $note_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr class="table-td">
                ...
                <td class="text-left" style="border-style: none;width:auto;">
                    ...
                    <a href="<?php echo e(route('audited_note_report',$note_list->auditedreport_id)); ?>"> <?php echo e($note_list->auditedreport_id); ?></a>
				</td>
                <td class="text-center" style="border-style: none; width:200px;" >
                    <?php echo e(date("dMy H:i:s",strtotime($note_list->created_at))); ?>
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/oceania/trunk/oceania/resources/views/cstore_audited_rpt/cstore_audited_note_list.blade.php ENDPATH**/ ?>