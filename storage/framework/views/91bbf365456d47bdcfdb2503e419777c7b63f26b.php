...
<div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row" style="margin-bottom: 5px;">
                    ...
                    <div class="col-sm-8">
                    <input type="text" class="form-control company-details" id="name" value="<?php echo e($company->name ?? ''); ?>" placeholder="Company Name">
                    </div>
                  </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row" style="margin-bottom: 5px;">
                    ...
                    <div class="col-sm-8">
						<input type="text" class="form-control company-details"
							id="business_reg_no"
							value="<?php echo e($company->business_reg_no??''); ?>"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group row" style="margin-bottom: 5px;">
                    ...
                    <div class="col-sm-8">
                    <input type="text" class="form-control company-details" id="gst_vat_sst" value="<?php echo e($company->gst_vat_sst??''); ?>" placeholder="GST/SST/VAT No">
                    </div>
                  </div>
            </div>

        </div>
        <?php if(!$companydirector->isEmpty()): ?>
        <?php $__currentLoopData = $companydirector; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="row director-div<?php echo e($row->id??''); ?>" <?php if($loop->last): ?> id="director-row" <?php endif; ?>>
            <div class="col-md-6">
                <div class="form-group row" style="margin-bottom: 5px;">
                    <label for="inputPassword" class="col-sm-4 col-form-label">Director</label>
                    <div class="col-sm-8">
                    <input type="text" class="form-control company-details" id="director_name<?php echo e($row->id??''); ?>" value="<?php echo e($row->name??''); ?>" placeholder="Director">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row" style="margin-bottom: 5px;">
                    ...
                    <div class="col-sm-7">
						<input type="text" class="form-control company-details"
							id="director_nric<?php echo e($row->id??''); ?>"
							value="<?php echo e($row->nric??''); ?>"
							placeholder="NRIC">
                    </div>

                    <div class="col-sm-1">
                        <?php if(!$loop->first): ?>
                        <div id="dlt-director" onclick="dltdirector_old(<?php echo e($row->id??''); ?>)"
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group row" style="margin-bottom: 5px;">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control company-details" id="office_address" value="<?php echo e($company->office_address??''); ?>" placeholder="Company Address">
                    </div>
                  </div>
            </div>
        </div>
        <?php if(!$companycontact->isEmpty()): ?>
        <?php $__currentLoopData = $companycontact; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rowc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="row contact-div<?php echo e($rowc->id); ?>" <?php if($loop->last): ?> id="contact-row" <?php endif; ?>>
            <div class="col-md-6">
                <div class="form-group row" style="margin-bottom: 5px;">
                    <label for="inputPassword" class="col-sm-4 col-form-label">Contact Person</label>
                    <div class="col-sm-8">
                    <input type="text" id="contact_person<?php echo e($rowc->id); ?>" value="<?php echo e($rowc->name); ?>" class="form-control company-details" placeholder="Name">
                    </div>
                  </div>
            </div>
            <div class="col-md-6">
                <div class="form-group row" style="margin-bottom: 5px;">
                    ...
                    <div class="col-sm-7">
						<input type="text" id="mobile<?php echo e($rowc->id); ?>" value="<?php echo e($rowc->mobile); ?>" class="form-control company-details"
							placeholder="Mobile"/>
                    </div>

                    <div class="col-sm-1">
                        <?php if(!$loop->first): ?>
                        <div id="dlt-director" onclick="dltcontact_old(<?php echo e($rowc->id??''); ?>)"
	...
	<div class="col-md-4 upload-area" id="uploadfile"
		...
		<?php if($company->corporate_logo??"" != null): ?>
			<div id="thumbnail_1" class="thmb" style="">
				<img style="object-fit:contain"
				src="<?php echo e(asset('images/company/'.$company->id.'/corporate_logo/'.$company->corporate_logo)); ?>" width="400px" height="200px">
			</div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                <input type="text" class="form-control company-details-location" id="location-name" value="<?php echo e($location->name??''); ?>" placeholder="Name">
                </div>
              </div>
        </div>
    </div>
    ...
    <div class="row">
		<div class="col-md-2">
			<div class="form-group row">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control company-details-time" id="time-start" value="<?php echo e($location->start_work??''); ?>" placeholder="Start">
				</div>
			  </div>
		</div>
		<div class="col-md-2">
			<div class="form-group row">
				...
				<div class="col-sm-8">
				  <input type="text" class="form-control company-details-time" id="time-end" value="<?php echo e($location->close_work??''); ?>" placeholder="End">
				</div>
			  </div>
		</div>
    </div><br>
...
<script>
var d_count = <?php echo e($row->id??"1"); ?>+1;
var cp_count = <?php echo e($rowc->id??"1"); ?>+1;
...
$( document ).ready(function() {
	...
	<?php if($company['msg']): ?>
		messageModal("<?php echo e($company['msg']); ?>");
	<?php endif; ?>
...
$("#edit-save").click(function(){
	...
	if(buttontype == "Edit"){
	   ...
	   // var director_nric = $('#director_nric').val();
		...
		$.ajax({
			url: "<?php echo e(route('screen.d.setting.saveCompanydetails')); ?>",
			type: 'post',
			headers: {
...
$("#edit-save-location").click(function(){
	...
	if(buttontype == "Edit"){
		...
		var data =
		$.ajax({
			url: "<?php echo e(route('screen.d.setting.saveLocationName')); ?>",
			type: 'post',
			headers: {
				'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
			},
...
$("#edit-save-time").click(function(){
	...
	if(buttontype == "Edit"){
		...
		var data =
		$.ajax({
			url: "<?php echo e(route('screen.d.setting.savetime')); ?>",
			type: 'post',
			headers: {
				'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
			},
...
function dltdirector_old(d_id){
	$.ajax({
		url: "<?php echo e(route('screen.d.setting.dltdirector')); ?>",
		type: 'post',
		headers: {
			'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
		},
...
function dltcontact_old(c_id){
	$.ajax({
		url: "<?php echo e(route('screen.d.setting.dltcontact')); ?>",
		type: 'post',
		headers: {
			'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
		},
...
async function del_logo() {
	await $.ajax({
		url: "<?php echo e(route('settings.delLogo')); ?>",
		type: 'get',
		success: function (response) {
...
async function uploadData(formdata){
	await del_logo();
	$.ajax({
        url: "<?php echo e(route('screen.d.setting.savelogo')); ?>",
        headers: {
			'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
		},
        type: 'post',
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/oceania/trunk/oceania/resources/views/setting/setting.blade.php ENDPATH**/ ?>