...
<div class="container-fluid">
	<div class="d-flex mt-0 mb-0 p-0"
		...
		<div style="" class="p-0 align-self-center col-sm-8">
			<h2 class="mb-0">Credit Account Ledger</h2>
		</div>
		<div style="" class="col-sm-4 p-0 align-self-center text-right">
...
<div class="modal fade" id="paymentModal" tabindex="-1"
	 ...
	 <div class="modal-dialog modal-dialog-centered"
		...
		<div class="modal-content bg-modal"  style="padding: 1rem;"	>
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/oceania/trunk/oceania/resources/views/credit_ac/credit_account_ledger.blade.php ENDPATH**/ ?>