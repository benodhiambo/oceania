...
var tablestockin = $('#fuelMgt').DataTable({
	...
	"autoWidth": false,
	"ajax": {
		"url": "<?php echo e(route('fuelProduct.ajaxJson')); ?>",
		"type": "GET",
		"data": {"location_id": "<?php echo e($location->id); ?>"},
		'headers': {
...
function update_quantity() {
	...
	$.ajax({
	  url: "<?php echo e(route('fuel_movement.stockUpdate')); ?>",
	  type: "POST",
	  'headers': {
			'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
		},
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/oceania/trunk/oceania/resources/views/fuel_stockmgmt/stockin.blade.php ENDPATH**/ ?>