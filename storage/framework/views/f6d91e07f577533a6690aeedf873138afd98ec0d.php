...
$(document).ready(function(){
    ...
    window.onstorage = event => {
        if (event.key != 'pumpDataState') return;
        console.log('***clear_storage: pumpDataState changed=',localStorage.getItem('pumpDataState'))
    };
...
<?php /**PATH /home/user/oceania/trunk/oceania/resources/views/landing/opos2_fuelpage.blade.php ENDPATH**/ ?>