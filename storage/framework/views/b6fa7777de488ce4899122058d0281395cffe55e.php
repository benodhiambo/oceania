...
#evReceiptDetailModal .modal-inside .row {
	padding: 0px;
	margin: 0px;
	color: #000;
}

#evReceiptDetailModal .modal-body {
	position: relative;
	flex: 1 1 auto;
		...
		<div class="row py-2 align-items-center"
			...
			<div class="row col-md-8 text-left m-0"
				style="justify-content:flex-end">
                 ...
                 <form action="<?php echo e(route('export_excel_fuel_receipt')); ?>" method="POST" style="margin-right: 0.5%;">
