			...
			<div hidden class="prd-overlay" id = "prd-overlay-<?php echo e($s); ?>">
				<div class="row prd-top-row" 
					...
					<div class="col-sm-5 m-0 p-0 text-right">
						<span id="prd-myr-<?php echo e($s); ?>"></span>
						...
						<div class="row m-0 p-0 w-100">
							<div class="col-sm-12 m-0 p-0">
								<input class="hide cover-input" type="number"
									...
									placeholder='0.00' id="custom_amount_input_<?php echo e($s); ?>"/>

								<input class="hide" type="number"
									id="custom_amount_input_<?php echo e($s); ?>_buffer"/>
...
<?php echo $__env->make('landing.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev/oceania/trunk/oceania/resources/views/landing/landing.blade.php ENDPATH**/ ?>