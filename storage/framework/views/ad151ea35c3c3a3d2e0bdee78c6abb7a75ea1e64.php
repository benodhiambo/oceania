	...
	activateLicence = () => {
		...
		$.ajax({
			...
			<?php if(empty($isLocationActive) && empty($isTerminalActive)): ?>
				url: "<?php echo e(route('localaccess.interface.licence')); ?>",
			<?php elseif(!empty($isLocationActive) && empty($isTerminalActive)): ?>
				url: "<?php echo e(route('localaccess.interface.licence-terminal')); ?>",
			<?php endif; ?>
...
<?php /**PATH /home/user/oceania/trunk/oceania/resources/views/landing/license.blade.php ENDPATH**/ ?>