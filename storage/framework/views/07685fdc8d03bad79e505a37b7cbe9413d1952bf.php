...
<div class="d-flex mt-0 p-0"
	 ...
	 <div class="col-md-1 align-self-center">
 		...
 		<?php if(!empty($product->thumbnail_1)): ?>
 			<div>
 				<img src="/images/product/<?php echo e($product->id); ?>/thumb/<?php echo e($product->thumbnail_1); ?>"
 	...
 	<div class="col-md-6 align-self-center">
 		<div class="row">
 			<div style="margin-left: -25px">
 				...
 				<p class="mb-0"><?php echo e($system_id); ?></p>
 			</div>
 		</div>
 	</div>
...
function generate_barcode() {
	$.get("<?php echo e(route('openitem.barcode.generate')); ?>", { p_id : "<?php echo e($system_id); ?>"}).done(function(res){
...
function yesDelete(barcode) {
	$.ajax({
		method: "post",
		url: "<?php echo e(route('openitem.barcode.delete')); ?>",
...
var url =  "<?php echo e(route('openitem.barcode.table.show', request()->systemid )); ?>"
function load_table(url) {
	var tableData = {};
	var prd = {
		'prd_id': '<?php echo e($product->id); ?>'
	}
	main_table = $('#tableinventorybarcode_default').DataTable({
		...
		"columnDefs": [
			...
			{"className": "dt-center vt_middle slim-cell", "targets": [2]},
...
$(document).ready(function () {
	...
	$('#save_barcodes').click(function(){
		...
		$.ajax({
			url: "<?php echo e(route('openitem.barcode.save')); ?>",
			data: {
			   'barcodes' : barcodes,
	...
	let url =  "<?php echo e(route('openitem.barcode.table.show')); ?>"
	load_table(url)
});

</script>

<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/oceania/trunk/oceania/resources/views/openitem/openitem_barcode.blade.php ENDPATH**/ ?>