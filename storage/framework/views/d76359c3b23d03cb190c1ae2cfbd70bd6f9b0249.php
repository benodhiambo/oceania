...
$('#update_cost_modal').on('hidden.bs.modal', function (e) {
	...
	console.log('***th stockin_updates***', JSON.stringify(stockin_updates))
});
    ...
    "drawCallback": function( settings ) {
		 ...
		 if (stockin_updates.length > 0) {
	    	stockin_updates.forEach((prd) => {
	    		...
	    		$('#cost_'+prd.tag_id).text(prd.cost)
			});
	    }
	    ...
	    api.rows().every( function ( rowIdx, tableLoop, rowLoop ) {
			let data = this.data();
			console.log( '***every*api.rows***', JSON.stringify(data.name));
		})
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev/oceania/trunk/oceania/resources/views/receiving_note/cstore_receiving_note.blade.php ENDPATH**/ ?>