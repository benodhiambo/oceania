<?php echo $__env->make('common.barcode_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		...
		<div style="padding:0" class="align-self-center col-sm-10">
			<div class="row mt-0">
				<div class="col-1 mb-1">
					<img src="<?php echo e(url('/images/product/' . $product->systemid .
				...
				<div class="col-10" style="display: inline-block;vertical-align: middle;align-items: center;">
					<p style="margin-bottom:4px;margin-top:10px"><?php echo e($product->description); ?></p>
					<span id="productSystemid"><?php echo e($product->systemid); ?></span>
				</div>
			</div>
		</div>
...
<div>
	<img id="barcode" style="display:none;">
		...
		let qrcode = 	"<?php echo e(request()->systemid); ?>";
		const	barcode_string = String('<?php echo e(request()->systemid); ?>');
...
<script>
	...
	var tableData = {};
	//tableData['systemid'] = '<?php echo e(request()->systemid); ?>';
	...
	var barcodeTable = $('#tableFLocaltionProduct').DataTable({
		...
		"autoWidth": false,
		"ajax": {
			"url": "<?php echo e(route('franchise.location_price.barcode.datatable', request()->systemid )); ?>",
			"type": "POST",
			data: function (d) {
...
d1.insertAdjacentHTML('afterend', '<tr role="row" class="odd" style="border:none"><td>1</td><td class="dt-center vt_middle" style="width:280px"><img id="barcode" class="mx-auto" src="'+func+'"> <?php echo e(request()->systemid); ?></td><td><div id="qrcode"></div></td><td></td><td></td><td></td><td></td><td></td></tr>');
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/dev/oceania/trunk/oceania/resources/views/local_price/barcode.blade.php ENDPATH**/ ?>