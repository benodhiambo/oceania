...
$(document).ready(function() {
	for (var i = 1; i <= <?php echo e(env('MAX_PUMPS')); ?>; i++) {
		var my_pump = i;
...
function process_enter(){
	...
	$.post("<?php echo e(route('local_cabinet.receipt.create')); ?>", {
			cash_received,
			payment_type,
			cal_item_amount,
			cal_sst,
...
<!-- END OPOS Prepaid -->
<?php /**PATH /home/user/oceania/trunk/oceania/resources/views/landing/opos_prepaid.blade.php ENDPATH**/ ?>