    ...
    <div class="row align-items-center">
        ...
        <div class="text-right col-md-3 pl-0" style="font-size:17px">
            <strong id="item_amount">
                <?php echo e(!empty($receipt->currency) ? $receipt->currency : 'MYR'); ?>
        ...
        <?php $__currentLoopData = $receiptproduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="row align-items-center" style="font-weight: normal">
                <div class="col-md-4 receipt-item-l">
                    <?php echo e(!empty($product->name) ? $product->name : ''); ?>
    ...
    <div class="row" style="text-align: center;margin: 10px auto;">
        <div class="col-md-12 d-flex" style="justify-content:space-around;margin-bottom:5px">
            ...
            <button class="btn btn-success bg-receipt-loyalty" style="padding-left:0;padding-right:0; margin-right: 5px;
                    font-size:13px;border-radius:10px; <?php if($receipt->status === 'voided'): ?> background: #3a3535;
...
<?php if($receipt->status === 'voided'): ?>
    ...
    <div id="void-div<?php echo e($receipt->id ?? ''); ?>" style="display:<?php if($receipt->status ==
    'voided'): ?> block <?php else: ?> none <?php endif; ?>" >
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-6 text-left" style="color:red;">
                <strong
                    id="void-time<?php echo e($receipt->id ?? ''); ?>"><?php echo e(\Carbon\Carbon::parse($receipt->voided_at)->format('dMy H:i:s') ?? ''); ?></strong>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 text-left" style="color:red;">
...
<?php if($refund && $receipt->status === 'refunded'): ?>
    <div class="container">
        <div style="font-size:14px;text-align:left; color:orange">
            ...
            <br>
            MYR <?php echo e(number_format($refund->refund / 100, 2)); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-8 pl-0 text-right">
                    <span style="font-weight: normal">
						<?php echo e(number_format($refund->newsales_item_amount/100,2)); ?>
            ...
            <div class="row">
                <div class="col-md-4 pr-0">
                    <span style="font-weight: normal">
						<?php echo e('SST ' . (float) $receipt->service_tax ?? '6'); ?>%
					</span>
                </div>
                <div class="col-md-8 pl-0 text-right">
                    <span style="font-weight: normal">
						<?php echo e(number_format($refund->newsales_tax/100,2)); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-8 pl-0 text-right">
                    <span style="font-weight: normal">
						<?php echo e(number_format($refund->newsales_rounding/100,2)); ?>
...
<script type="text/javascript">
    ...
    function print_receipt(receipt_id) {
        ...
        $.ajax({
            url: "<?php echo e(route('receipt.fuel.print')); ?>",
            headers: {
...
<?php /**PATH /home/user/oceania/trunk/oceania/resources/views/fuel_receipt/fuel_receipt.blade.php ENDPATH**/ ?>