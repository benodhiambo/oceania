...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="row py-2"
            ...
            <div class="col align-self-center" style="width:80%">
                <h2 style="margin-bottom:0">Location Product: Stock Out</h2>
            </div>
            ...
            <div class="col col-auto align-self-center">
                <button class="btn btn-success bg-confirm-button sellerbutton" 
				id="confirm_update" onclick="update_quantity()"
				style="padding-left:10px;margin-right:0px;display:block;
				cursor: not-allowed;border-radius:10px; background: gray;">
				<span>Confirm</span>
                </button>
            </div>
        </div>
        ...
        <div style="padding-left:0;padding-right:0;" class="col-sm-12">
            <table id="fuelMgt" class="table table-bordered">
                ...
                <tr>
                    ...
                    <th style="width:60px;!important" nowrap>Qty</th>
                    <th style="width:140px;text-align: center;" nowrap>Qty&nbsp;Qut</th>
                </tr>
                </thead>
                <tbody>
    ...
    <script>
		...
		var tablestockin = $('#fuelMgt').DataTable({
			...
			"autoWidth": false,
			"ajax": {
				"url": "<?php echo e(route('franchise.location_price.prd_ajaxJson')); ?>",
				"type": "GET",
				"data": {"location_id": "<?php echo e($location->id); ?>", 'type': 'out'},
				'headers': {
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/oceania/trunk/oceania/resources/views/inv_stockmgmt/stockout.blade.php ENDPATH**/ ?>