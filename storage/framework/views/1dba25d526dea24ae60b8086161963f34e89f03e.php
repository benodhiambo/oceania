              ...
              <tr class="">
                        ...
                        <td class=" dt-right vt_middle slim-cell">
                                <div class="d-flex align-items-center justify-content-center">
                                    ...
                                    <input type="number" id="number_<?php echo e($k + 1); ?>" oninput="changeValueOnBlur('<?php echo e($k + 1); ?>')" class="number product_qty js-product-qty" value="<?php echo e($product->Iqty ?? 0); ?>" min="0" required="">
                        ...
                        <td class="text-right" style="border-style: none;width:10%;">
                           <a href="#"  onclick="add_cost_modal('#add_cost_modal','<?php echo e(number_format($product->Icost / 100,2)); ?>')"  id="cost_<?php echo e($k + 1); ?>"> <?php echo e(number_format($product->Icost / 100,2)); ?> </a>
                        </td>
                        <td class="text-right" style="border-style: none;width:10%;" id="costvalue_<?php echo e($k +1); ?>">
            ...
            <div class="modal-body bg-purplelobster">
				<div class='text-center ' style="margin:auto">
					...
					<div class="typewriter"
						...
						border:3px solid rgb(176, 21, 248); color: #0c0c0c; background:#fff;border-radius:3px; ">
...
function add_cost_modal(x,value){
 let de = document.getElementById('cost_fk_text');
  de.textContent = value;
 $(x).modal('show');
