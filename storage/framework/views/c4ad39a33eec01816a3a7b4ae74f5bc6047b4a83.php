...
<script type="text/javascript"
		src="<?php echo e(asset('js/qz-tray.js')); ?>"></script>
<script type="text/javascript"
		src="<?php echo e(asset('js/opossum_qz.js')); ?>"></script>
<script type="text/javascript"
		src="<?php echo e(asset('js/JsBarcode.all.min.js')); ?>"></script>
<script type="text/javascript"
		src="<?php echo e(asset('js/console_logging.js')); ?>"></script>
<style>
::placeholder {
	text-align:center;
}
...
<?php echo $__env->make("carpark.header", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	...
	<div class="row m-0  pb-0 pl-0 pr-0 col-12"
			...
			<div style="padding-right:20px"
				...
				<div class="row mt-1">
					<div class="col-md-8 text-left"  id="sst">
						<?php echo e(!empty($terminal_all_value->taxtype)?strtoupper($terminal_all_value->taxtype):"SST"); ?>

						<?php echo e(empty($terminal_all_value->tax_percent) ? '0.00': $terminal_all_value->tax_percent); ?>%
		...
		<div class="row col-md-12 pl-0 pr-0">
			<div class="col-md-12 row pr-0 pl-0"
				...
				<button class="btn btn-success btn-sq-lg screend-button
					bg-virtualcabinet"
					onclick="window.open('<?php echo e(route('ev-receipt-list',[date('Y-m-d')])); ?>','_blank')"
		...
		<div class="row col-md-12 pl-0 pr-0">
			<div class="col-md-12 row pr-0 pl-0"
				...
				<a href="<?php echo e(route('screen.d')); ?>"
				   target="_blank"
				...
				<button class="btn ml-0 opos-ev-button"
					...
					<img src="<?php echo e(asset('images/ev_exit_button.png')); ?>"
		...
		<div class="row col-md-12 pl-0 pr-0">
			<div class="col-md-12 row pr-0 pl-0"
				...
				<button class="btn btn-success btn-sq-lg
					ev-perhour-button <?php if( $current_setting_mode == 'hour' ): ?> kwh-hour-button-disabled <?php endif; ?> "
				...
				<button id="kwh-mode" class="btn btn-success btn-sq-lg
					ev-kwh-button <?php if( $current_setting_mode == 'kwh' ): ?> kwh-hour-button-disabled <?php endif; ?>"
	...
	<div class="container-fluid row"
		...
		<div style="color:white;position:absolute;right:30px">
			<img style="width:80px"
				 src="<?php echo e(asset('images/ev_transparent.png')); ?>">
		</div>
	</div>
</div>
...
<div class="col-md-8 pb-0 m-0 pr-0"
	...
	<table class="w-100" id="tableCarParkOpera">
		...
		<?php echo $__env->make("carpark.carparklot_table", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		</tbody>
	</table>
	...
	<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content modal-inside bg-purplelobster">
         ...
         <div class="modal-body text-center p-0" id="wallet-spay">
			...
			<div id= "sc">
				<h5 class="mt-3" id="amt" data-id="<?php echo e($terminal->currency ?? ''); ?>">
				Sending order amount <?php echo e($terminal->currency ?? ''); ?>
...
function payClick(id, hr, rate, text_rate, text_amount, amount, carparkoper,
 carparklot, kwh, text_kwh, mode, kwh_db) {
	...
	let percent = (<?php echo e($terminal_all_value->tax_percent); ?> / 100) + 1;
	let percent_no_one = <?php echo e($terminal_all_value->tax_percent); ?> / 100;
	if(mode == 'hour')
	{
		amount = hr * (rate /100);
	}else{
	...
	$.ajax({
		method: "post",
		url: "<?php echo e(route('carparkoper.getRounding')); ?>",
		data: {amount: amount}
	}).done((data) => {
...
function statusClick(id, amount, carparkoper_id) {
	$.ajax({
		method: "post",
		url: "<?php echo e(route('carparkoper.actionStatus')); ?>",
		data: {
			id: id,
			int_amount: amount,
...
$(document).ready(function(){
	...
	var paid_count_var = localStorage.getItem('paid_count_var');
		$.ajax({
		method: "post",
		url: "<?php echo e(route('carparkoper.multiTransactionCheck')); ?>",
		data: {
...
function hour_mode() {
	...
	if( $( "#tableCarParkOpera .active_button_active" ).hasClass( "btn-prawn-custom" ) ||
		...
		$.ajax({
			method: "post",
			url: "<?php echo e(route('carparkoper.changeMode')); ?>",
			data: {mode: 'hour'}
		}).done((data) => {
			console.log(data);
			location.reload();
...
<?php echo $__env->make('carpark.carpark_payment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('carpark.carpark_wallet', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make("common.footer", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php echo $__env->make('landing.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/oceania/trunk/oceania/resources/views/carpark/carpark_landing.blade.php ENDPATH**/ ?>