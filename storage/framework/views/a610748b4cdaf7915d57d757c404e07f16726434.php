						...
						<div class="col-md-12 mt-auto pt-2 pb-0 m-0 pl-0 pr-0"
							...
							<div class="row" style="height: 50px;">
								<div style=""
									...
									<div style="position:absolute;left:<?php echo e($left); ?>;top:25px"
										class="">
										<div class="ml-0 p-0" style="text-align:center;
											position:relative; left: 14px; top: -27px;
											font-size: 28px; color:white;"
											id="pump-number">
											<b id="pump-number-main-<?php echo e($i); ?>" style="color: black; font-size: 25px"><?php echo e($i); ?></b>
										</div>
									</div>
								</div>
	...
	<div class="col-md-12 ml-0 pl-0 mb-1">
		...
		<div style="float:left;">
			...
			<input class="hide" type="number"
				...
				border-radius:10px;height: 70px !important;
				width: 145px;outline: none;text-align:center;"
				placeholder='0.00' id="custom_litre_input_<?php echo e($i); ?>"/>

			<input class="hide" type="number"
				id="custom_litre_input_<?php echo e($i); ?>_buffer"/>
		...
		<div style="clear:both">
			...
			<input class="hide" type="number"
				...
				border-radius:10px;height: 70px !important;
				width: 145px;outline: none;text-align:center;"
				placeholder='0.00' id="custom_amount_input_<?php echo e($i); ?>"/>

			<input class="hide" type="number"
				id="custom_amount_input_<?php echo e($i); ?>_buffer"/>
			<?php endfor; ?>
...
<?php echo $__env->make('landing.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/oceania/trunk/oceania/resources/views/landing/mob_landing.blade.php ENDPATH**/ ?>