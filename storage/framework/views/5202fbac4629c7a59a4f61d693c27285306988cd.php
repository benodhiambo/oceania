	...
	<div class="d-flex mt-0" style="width: 100%">
        ...
        <div style="display:flex;justify-content:flex-end"
            ...
            <span style="float:right;border-radius:10px;line-height:1.2" class="m-0 mr-4">
                <b>Push Date:</b><br><?php echo e($date??""); ?>

            </span>


			<button class="btn btn-success sellerbuttonwide"
				data-toggle="modal" data-target="" onclick="window.open('<?php echo e(route('product_mapping')); ?>','_blank')"
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/oceania/trunk/oceania/resources/views/local_fuelprice/local_fuelprice.blade.php ENDPATH**/ ?>