...
function process_finish() {
	...
	$.ajax({
		method: "GET",
		url: "<?php echo e(route('ev-receipt-id')); ?>",
	}).done((data) => {
		...
		$.ajax({
			method: "post",
			url: "<?php echo e(route('create-ev-list')); ?>",
			data: data,
		}).done((response) => {
...
<?php /**PATH /home/user/oceania/trunk/oceania/resources/views/carpark/carpark_payment.blade.php ENDPATH**/ ?>