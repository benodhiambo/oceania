...
<script  type="text/javascript" src="<?php echo e(asset('js/osmanli_calendar.js')); ?>?version=<?php echo e(date("hmis")); ?>"></script>
...
<div id="landing-view">
	...
	<div class="container-fluid">
        ...
        <div style="padding-left:2px">
            <form action="<?php echo e(route('cost_value_report')); ?>" method="POST">
		...
		<div style="padding-left:2px">
		<form action="<?php echo e(route('c-storePL')); ?>" method="POST">
			...
			<div class="col-md-10">
				<div style="right:200px;display:inline; margin-bottom:20px">
					<button class="btn btn-success bg-download"
						style="height:70px;width:70px;border-radius:10px;
						outline:none;font-size: 14px">PDF
					</button>
...
function ev_end_dialog(e) {
    ...
    if(localStorage.getItem("showEVStartDate") == null){
        ...
        start_date_dialog.MIN_DATE.setDate(start_date_dialog.MIN_DATE.getDate()+1)
...
function prev_month(){
   let  min_date = new Date('<?php echo e($approved_at); ?>');
        ...
        <div class="modal-dialog modal-dialog-centered" role="document"
            ...
            <div class="modal-content bg-purplelobster">
                ...
                <?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$mm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     ...
                     <?php if($now > $key && $now != $key): ?>
                    <li class="btn  btn-log btn-primary discountbutton yearBtn <?php echo e($mm['sort_name']); ?>"
                        style= "padding-left:0;padding-right:0;padding-top:20px; cursor:pointer"
                        onclick="select_month('<?php echo e($mm["sort_name"]); ?>')" value="<?php echo e($mm['sort_name']); ?>" id="past">

                        <span><?php echo e($mm['sort_name']); ?></span>

                    </li>
                    <?php elseif($mm["sort_name"]== $nowM && $key == $now): ?>
                     <li class="btn  btn-log btn-success  discountbutton yearBtn <?php echo e($mm['sort_name']); ?>"
                        style= "padding-left:0;padding-right:0;padding-top:20px; cursor:pointer"
                        onclick="select_month('<?php echo e($mm["sort_name"]); ?>')" value="<?php echo e($mm['sort_name']); ?>" id="present">
                    ...
                    <?php else: ?>
                        ...
                        onclick="select_month('<?php echo e($mm["sort_name"]); ?>')" value="<?php echo e($mm['sort_name']); ?>" id="future">
...
<div class="modal fade" id="showDateModalFromS" tabindex="-1" role="dialog" aria-labelledby="staffNameLabel"
  ...
  <div class="modal-dialog modal-dialog-centered  mw-75 w-50" role="document">
    ...
    <form id="status-form" action="<?php echo e(route('logout')); ?>" method="POST" style="display: none;">
      <?php echo csrf_field(); ?>
    </form>
  </div>
</div>
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/oceania/trunk/oceania/resources/views/report/report.blade.php ENDPATH**/ ?>