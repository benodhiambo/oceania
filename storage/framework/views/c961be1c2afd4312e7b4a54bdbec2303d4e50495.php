	...
	<div class="flex_table" style="width: 397px; height:50px;">
		<div style="padding-left:0"
			...
			<div class="col-md-9" style="padding-left:10px">
				<img src="<?php echo e(asset('images/h2_logo.png')); ?>"
...
<div class="row pt-2 pb-0 m-0 pl-0 pr-0" style="">
	<div class="col-md-4 pt-2 pb-0 m-0 pl-0 pr-0"
				...
				<div class="row">
					<div class="col-md-12 pr-0 pl-0" style="position: relative">
						...
						<button class="btn btn-success btn-sq-lg screend-button
							bg-virtualcabinet"
							onclick="window.open('<?php echo e(url('h2-receipt-list')); ?>/<?php echo e(date("Y-m-d")); ?>','_blank')"
					...
					<div style="float:left;width:100%">
						...
						<button class="btn opos-h2-button"
							...
							<img src="<?php echo e(asset('images/h2_logo_exit.png')); ?>"
		...
		<?php for($i = env('H2_MAX_PUMPS'); $i>=1; $i--): ?>
		<div style="" hidden class="overlay2" id="overlayover-<?php echo e($i); ?>"></div>
		<div style="" hidden class="overlay2" id="h2-overlay-sa-<?php echo e($i); ?>"></div>
			<div class="row m-0 pt-2 pb-0 pl-0 pr-0 pump-main-block"
				id="pump-main-block-<?php echo e($i); ?>" style="display:none;align-items:flex-end">
				...
				<div class="col-md-10 pt-0 pb-0 m-0 pr-0"
					...
					<div style="padding-right:20px;min-height: 200px;"
						...
						<div class="row p-0 m-0 text-white">
							<div class="col-4 p-0 m-0" id="table-PRODUCT-<?php echo e($i); ?>"></div>

							<div class="col-3 text-center" id="table-PRICE-<?php echo e($i); ?>"></div>

							<div class="col-3 text-center" id="table-QTY-<?php echo e($i); ?>"></div>

							<div class="col-2 p-0 m-0 text-right"
								id="table-MYR-<?php echo e($i); ?>">0.00
							</div>
						</div>
				...
				<div class="row record" style="margin-bottom:5px !important">
					<div style="padding-right:20px"
						...
						<input id="cash-input-cash<?php echo e($i); ?>" type="hidden">
...
<div class="row">
	...
	<div class="col-md-8"
		...
		<?php for($i=1 ; $i<=env('H2_MAX_ROWS'); $i++): ?>
			<div class="row col-md-12" style="margin:0px; padding:0px;">

			<?php for($j=1 ; $j<=env('H2_MAX_COLUMNS'); $j++): ?>
				<div class="col_panel">
					...
					margin-left: 0px;">
						...
						<div class="col-md-4 col_panel_inner">
							...
							<button class="btn h2-button-pump-idle mb-1" style="float: right !important;"
								id="pump-button-<?php echo e($s); ?>" onclick="select_pump(<?php echo e($s); ?>)" >
								<img src="<?php echo e(asset('images/h2_logo.png')); ?>"
						...
						<div class="col-md-4 line_before_number"
							...
							<span style="line-height:1.2" id="total-fuel-pump-<?php echo e($s); ?>">50.00</span>
							<span style="line-height:1.8" id="total-final-filled-<?php echo e($s); ?>">0.00</span>
							<span id="total-final-kg-<?php echo e($s); ?>">0.00</span>
						...
						<div class="col-md-12 p-0 m-0">
							...
							<div class="row text-white"
								...
								<?php if(!empty($nozzleFuelData->
									...
									<div id="product-first-<?php echo e($sno); ?>" style='display:none;'>
										<?php echo e($product->id); ?>

									</div>
									<input type="hidden" id="selected-pump-<?php echo e($s); ?>" value="<?php echo e($sno); ?>">

									<span class='p-product product-row-<?php echo e($sno); ?> product-item-<?php echo e($product->id); ?><?php echo e($s); ?>'>
									<img class="iHover fuelproductimages-<?php echo e($s); ?> product-disable-offline noclick fuel-product-image"
										...
										onclick="selectProduct('<?php echo e($s); ?>', '<?php echo e($product->id); ?>', '<?php echo e($product->name); ?>',
...
<?php echo $__env->make('h2.h2_product_logic', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('h2.h2_wallet', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('landing.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/oceania/trunk/oceania/resources/views/h2/h2_landing.blade.php ENDPATH**/ ?>