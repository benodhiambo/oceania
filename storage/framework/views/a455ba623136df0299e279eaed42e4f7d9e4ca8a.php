    ...
    <script>
        ...
        var tablestockin = $('#tableFLocaltionProduct').DataTable({
            ...
            "ajax": {
                ...
                "url": "<?php echo e(route('openitem.openitem_stockoutlist')); ?>",
                "type": "POST",
                data: function (d) {
...
<?php echo $__env->make('common.web', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/user/oceania/trunk/oceania/resources/views/openitem/openitem_stockout.blade.php ENDPATH**/ ?>