...
//	'123456789012345678901234567890123456789012345'
	...
	<?php $__currentLoopData = $receiptproduct; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		...
		'<?php echo e(str_pad(number_format(($receiptdetails->total/100),2), 7, " ", STR_PAD_LEFT)); ?>' + '\x0A',
	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
//	'123456789012345678901234567890123456789012345'
	'---------------------------------------------' + '\x0A',
	'Item Amount                        '+ '<?php echo e(str_pad(number_format($receiptdetails->item_amount / 100, 2), 10, " ", STR_PAD_LEFT)); ?>' + '\x0A',

	'<?php echo e(!empty($terminal->taxtype)?strtoupper($terminal->taxtype):"SST"); ?> <?php echo e($terminal->tax_percent); ?><?php echo e(str_pad("%",20," ",STR_PAD_RIGHT)); ?><?php echo e(str_pad(number_format($receiptdetails->sst / 100, 2), 20, " ", STR_PAD_LEFT)); ?>' + '\x0A',

//	'123456789012345678901234567890123456789012345'
	'<?php echo e(str_pad("Rounding",25," ",STR_PAD_RIGHT)); ?>' + '<?php echo e(str_pad(number_format($receiptdetails->rounding / 100, 2), 20, " ", STR_PAD_LEFT)); ?>' + '\x0A',
	'---------------------------------------------' + '\x0A',
	'\x1B' + '\x21' + '\x08',	// emphasized mode on
	'Total                    '+'<?php echo e(str_pad(number_format($receiptdetails->item_amount / 100 + $receiptdetails->sst / 100 + $receiptdetails->rounding / 100, 2), 20, " ", STR_PAD_LEFT)); ?>' + '\x0A',
	'\x1B' + '\x21' + '\x00',	// emphasized mode off
...
//	'123456789012345678901234567890123456789012345'
	...
	'Credit Card              '+ <?php if($receipt->payment_type == "creditcard"): ?>'<?php echo e(str_pad(!empty($receiptdetails->creditcard)?number_format((($receiptdetails->creditcard/100)+((5 * round(($receiptdetails->creditcard-$receipt->cash_change) / 5))-($receiptdetails->creditcard-$receipt->cash_change))/100),2):"0", 20, " ", STR_PAD_LEFT)); ?>' <?php else: ?>'<?php echo e(str_pad("0.00", 20, " ", STR_PAD_LEFT)); ?>' <?php endif; ?> + '\x0A',

//	'123456789012345678901234567890123456789012345'
	'Wallet                   '+ <?php if($receipt->payment_type == "wallet"): ?>'<?php echo e(str_pad(!empty($receiptdetails->wallet)?number_format((($receiptdetails->wallet/100)+((5 * round(($receiptdetails->wallet-$receipt->cash_change) / 5))-($receiptdetails->wallet-$receipt->cash_change))/100),2):"0.00", 20, " ", STR_PAD_LEFT)); ?>' <?php else: ?>'<?php echo e(str_pad("0.00", 20, " ", STR_PAD_LEFT)); ?>' <?php endif; ?> + '\x0A',

//	'123456789012345678901234567890123456789012345'
	'Credit Account           '+ <?php if($receipt->payment_type == "creditac"): ?>'<?php echo e(str_pad(!empty($receiptdetails->creditac)?number_format((($receiptdetails->creditac/100)+((5 * round(($receiptdetails->creditac-$receipt->cash_change) / 5))-($receiptdetails->creditac-$receipt->cash_change))/100),2):"0.00", 20, " ", STR_PAD_LEFT)); ?>' <?php else: ?>'<?php echo e(str_pad("0.00", 20, " ", STR_PAD_LEFT)); ?>' <?php endif; ?> + '\x0A',
	...
	'\x1B' + '\x61' + '\x31',	// center align
	'Thank You!' + '\x0A',
	'\x0d' + '\x0a',			// added bunch of lfs for xp-e200m
	'\x0d' + '\x0a',
	'\x0d' + '\x0a',
	'\x0d' + '\x0a',
	'\x0d' + '\x0a',
...
<?php /**PATH /home/user/oceania/trunk/oceania/resources/views/printing/fulltank_receipt_template_escpos.blade.php ENDPATH**/ ?>