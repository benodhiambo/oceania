...
<body>
		...
		<tr>
			<td valign="bottom" colspan="5" align="right" >
				...
				@if(!empty($requestValue['start_date']) && !empty($requestValue['end_date']))
					{{ date('dMy',strtotime($requestValue['start_date'])) }} - {{ date('dMy',strtotime($requestValue['end_date'])) }}
				@endif
				</p>
			</td>
		</tr>
        ...
        @foreach($product_details as $key => $product)
            ...
            <tr class="table-td">
				...
				<td style="text-align:right;border-style: none">
					{{ number_format($product->rec_price/($product->tax+100),2) }}
				</td>
				-->
				<td style="text-align:right;border-style: none">
    ...
    <table border="0" cellpadding="0" cellspacing="0" class="table"
        ...
        $grandTotal=0;
        ?>
        @foreach($receipt_refund as $key => $receipt)
            <?php
            ...
            <tr class="table-td">
                ...
                <td style="text-align:right;border-style: none">
                    {{ number_format($receipt->refund_amount,2) }}
                </td>
