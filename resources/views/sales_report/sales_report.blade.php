...
<div id="landing-view">
	...
	<div class="container-fluid">
		...
		<div>
		<form action="{{route('sales.cstore.report.print.pdf')}}" method="POST">
		...
		<form action="{{route('sales.fuel.report.print.pdf')}}" method="POST">
		...
		<div style="padding-left:15px">
		<form action="{{route('sales.ev.report.print.pdf')}}" method="POST">
		...
		<form action="{{route('sales.h2.report.print.pdf')}}" method="">
		...
		<div style="padding-left:30px">
		<form action="{{route('sales.opt.report.print.pdf')}}" method="">
			...
			<div style="right:200px;display:inline;padding-left:0;margin-bottom:20px">
				...
				text-align: center;"
				value="End Date"
				onclick="outdoor_payment_terminal_start()"
			...
			<div style="right:200px;display:inline;padding-left:0;
				...
				padding-left:0px; text-align: center;"
				value="End Date"
				onclick="outdoor_payment_terminal_end()"
		...
		<div style="padding-left:30px">
		<form action="{{route('sales.oew.report.print.pdf')}}" method="">
...
function pdfPrint(){
        ...
        $.ajax({
			url: "{{route('sales.cstore.report.print.pdf')}}",
            type: "post",
            'headers': {
