...
<div class="modal-body pb-0"
	...
	<div class="row align-items-center" style="font-weight: normal">
		...
		<div class="pl-3 col-md-2 receipt-item-c ">
			{{!empty($product->quantity)?number_format($product->quantity):"1"}}
		</div>
	...
	<div class="row" style="text-align: center;margin: 10px auto;">
		<div class="col-md-12 d-flex"
			...
			-->
			<a target="_blank"
				href="{{route('local_cabinet.loyaltyPoints',$receipt->id)}}">
			...
			<button class="nohover sellerbutton"
				...
				<img src="{{asset('images/basket_transparent.png')}}"
					...
					style="border:none;filter:invert(100%);width:50px;
	...
	<div id="void-div{{$receipt->id??''}}"
		...
		<div class="row">
			<div class="col-md-6 text-left"  style="color:red;">
				<b id="void-time{{$receipt->id??''}}">
				{{ date('dMy', strtotime($receipt->voided_at)) }}
				</b>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6 text-left"  style="color:red;">
				<b id="void-reason{{$receipt->id??''}}">
				{{$receipt->void_reason??''}}
				</b>
			</div>
		</div>
