					...
					<div class="eightbuttons">
						<div class="col-md-12 mt-auto pt-2 pb-0 m-0 pl-0 pr-0"
							...
							<div class="row" style="height: 50px;">
								...
								<div class="col-md-6 p-0 give-me-left-{{$i}}
									left-7" style="bottom: 26px; left:7px;">
									<button class="btn btn-danger onHoverGreen
									poa-button-number-payment-cancel-disabled
									cancel-pump-number-{{$i}}"
									style="padding-left:0; padding-right:0;"
									onclick="voidPumpAndDeAuthorize({{ $i }})">
									<span style="font-size:14px;margin-left:-1px;">Cancel
									</span>
									</button>
								</div>
							</div>
	...
	@for($i=1 ; $i<=env('MAX_ROWS'); $i++)
		...
		margin-left: 0px;">
			...
			<div class="col-md-12 p-0 m-0">
				...
				<!-- Display Cover Over Products -->
				<div style="cursor:pointer;" onclick="remove_start_cover('{{$s}}')"
					class="scover" id = "scover-{{$s}}">
					<span style="color: white; z-index: 1200; font-size: 25px;"
           ...
           Would you like to cancel the current transaction?</h5>
			...
			padding-left: 0px; padding-right: 0px;">
				<div class="col-md-6 p-0 text-center"
					style="bottom: 26px; left:7px;">
					<button style="width: 100%; " class="btn btn-danger onHoverGreen
						cancel-pump-number-0
						poa-button-number-payment-cancel-disabled1"
						style="padding-left:0; padding-right:0;"
						id="cancelTxn"
