...
<script>
	...
	*/
    ...
    var pump_selected = function(pump_no, forced = false, remove_selected_info = true) {
        ...
        if(pumpData['pump' + pump_no].paymentStatus != "Paid"){
            ...
            $('#total-fuel-pump-' + pump_no).text("50.00");
       ...
       /* if(pds == null || pds == undefined){
        ...
        if (pumpData) {
            if (pump_no != slcpump || slcpump === undefined) {
                pumpData['pump' + pump_no].dose = '50.00';
	...
	*/
    ...
    function show_select_pump_modal() {
        let screen_a_product = $('div[id *="table-PRODUCT-"]').text()
        let screen_a_price = $('div[id *="table-PRICE-"]').text()
        let screen_a_qty = $('div[id *="table-QTY-"]').text()

        log2laravel('debug', '***show_select_pump_modal***');
        log2laravel('debug', 'show_select_pump_modal: screen_a_product ='+screen_a_product);
        log2laravel('debug', 'show_select_pump_modal: screen_a_price ='+screen_a_price);
        log2laravel('debug', 'show_select_pump_modal: screen_a_qty ='+screen_a_qty);
        ...
        log2laravel('info', 'Product Selected: screen_a_product ='+screen_a_product);
        return true
    }
