<?php
Route::get('pump-authorize-fulltank/{pump_no}/{type}/{dose}/{ipaddr}','OposPetrolStationPumpController@pumpAuthorize');

Route::get('pump-authorize/{pump_no}/{type}/{dose}/{ipaddr}/{nozzle?}/{price?}','OposPetrolStationPumpController@pumpAuthorize');

Route::get('pump-authorize-fuel-grade/{pump_no}/{type}/{dose}/{ipaddr}/{nozzle?}/{price?}/{fuelgradeid?}','OposPetrolStationPumpController@pumpAuthorize');
