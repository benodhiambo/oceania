...
Route::get('audited_note_report/{id}', 'CStoreAuditedRptController@view_audited_report')->name('audited_note_report');
Route::post('update_audited_notes', 'CStoreAuditedRptController@updateAuditReport')->name('update_audited_notes');

// Mobile view
Route::get('mob-audited-rpt', 'CStoreAuditedRptController@mobileView')->name('mob-audited-rpt');
